# TODO: adapt Traditional Chinese for Exercism
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 39: <define>
   - `glossary.md` line 60: Jiki
   - `glossary.md` line 61: Jiki
   - `glossary.md` line 96: Jiki
   - `glossary.md` line 99: Jiki
   - `glossary.md` line 100: Jiki
   - `glossary.md` line 108: <define>
   - `glossary.md` line 110: <define>
   - `glossary.md` line 111: <define>
   - `glossary.md` line 117: Jiki
