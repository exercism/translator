# Turkish (tr) glossary notes

## 2026-09-20: Adapted for Exercism (agent; nothing here is a native speaker's decision)

This glossary was forked from Jiki's Turkish glossary when Exercism's translator repo was
...
characters and physical metaphors) went with the fork; every decision about the Turkish
...
Turkish has been asked yet, and an agent's invented rendering would read as an agreed one.
