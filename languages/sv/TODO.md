# TODO: adapt Swedish for Exercism
...
- `guide.md`: removed the whole section `## Term clarification (Swedish realisation)` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 14: Jiki
   - `guide.md` line 46: Jiki
   - `guide.md` line 50: Jiki
   - `guide.md` line 51: Jiki
   - `guide.md` line 82: Jiki
   - `guide.md` line 96: Jiki
   - `guide.md` line 103: Jiki
   - `guide.md` line 104: Jiki
   - `guide.md` line 109: Jiki
   - `glossary.md` line 42: Jiki
   - `glossary.md` line 44: <define>
   - `glossary.md` line 46: Jiki
   - `glossary.md` line 51: <define>
   - `glossary.md` line 52: <define>
   - `glossary.md` line 111: <define>
   - `glossary.md` line 124: Jiki
