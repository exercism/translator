# TODO: adapt Simplified Chinese for Exercism
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `glossary.md` line 19: <define>
   - `glossary.md` line 64: Jiki
   - `glossary.md` line 65: Jiki
   - `glossary.md` line 108: Jiki
   - `glossary.md` line 115: Jiki
   - `glossary.md` line 118: Jiki
   - `glossary.md` line 134: <define>
   - `glossary.md` line 136: <define>
   - `glossary.md` line 144: Jiki
