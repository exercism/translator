# TODO: adapt Finnish for Exercism
...
- `guide.md`: removed the whole section `## Term clarification (Finnish realisation)` (Jiki's product, world or source-markup model).
- `guide.md`: removed the whole section `## Product and strand names` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 72: Jiki
   - `guide.md` line 139: Jiki
   - `guide.md` line 140: Jiki
   - `guide.md` line 143: Jiki
   - `guide.md` line 144: Jiki
   - `guide.md` line 149: Jiki
   - `glossary.md` line 45: Jiki
   - `glossary.md` line 50: <define>
   - `glossary.md` line 55: Jiki
   - `glossary.md` line 60: <define>
   - `glossary.md` line 61: <define>
   - `glossary.md` line 135: <define>
