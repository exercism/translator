# TODO: adapt Persian for Exercism
...
- `guide.md`: removed the whole section `## Term clarification (Persian realisation)` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 11: Jiki
   - `guide.md` line 100: stamp
   - `guide.md` line 133: <define>
   - `guide.md` line 135: <define>
   - `guide.md` line 140: <define>
   - `guide.md` line 184: Jiki
   - `guide.md` line 189: Jiki
   - `guide.md` line 199: Jiki
   - `guide.md` line 200: Jiki
   - `glossary.md` line 33: Jiki
   - `glossary.md` line 34: Jiki
   - `glossary.md` line 42: Jiki
   - `glossary.md` line 49: Jiki
   - `glossary.md` line 52: Jiki
   - `glossary.md` line 58: <define>
