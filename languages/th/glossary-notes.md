...
This glossary was forked from Jiki's Thai glossary when Exercism's translator repo was
...
characters and physical metaphors) went with the fork; every decision about the Thai
...
Thai has been asked yet, and an agent's invented rendering would read as an agreed one.
...
- `scenario (an exercise test case)` → สถานการณ์. Also the concept title.
