# TODO: adapt Bengali for Exercism
...
- `guide.md`: removed the whole section `## The Jiki physical metaphors` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 111: <define>
   - `guide.md` line 114: <define>
   - `guide.md` line 117: <define>
   - `guide.md` line 123: <define>
   - `guide.md` line 129: <define>
   - `guide.md` line 132: <define>
   - `guide.md` line 134: <define>
   - `guide.md` line 135: <define>
   - `guide.md` line 172: Jiki
   - `guide.md` line 173: Jiki
   - `glossary.md` line 12: <define>
   - `glossary.md` line 14: <define>
   - `glossary.md` line 19: Jiki
   - `glossary.md` line 50: <define>
   - `glossary.md` line 56: <define>
   - `glossary.md` line 73: Jiki
   - `glossary.md` line 74: Jiki
   - `glossary.md` line 85: Jiki
   - `glossary.md` line 100: Jiki
   - `glossary.md` line 113: <define>
   - `glossary.md` line 115: <define>
   - `glossary.md` line 123: Jiki
