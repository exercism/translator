# TODO: adapt Hebrew for Exercism
...
- `glossary.md`: removed the whole section `## Product and strand names` (Jiki's product, world or source-markup model).
- `glossary.md`: removed the whole section `## Jiki physical metaphors` (Jiki's product, world or source-markup model).
- `guide.md`: removed the whole section `## Term clarification (Hebrew realisation)` (Jiki's product, world or source-markup model).
- `guide.md`: removed the whole section `## The name "Jiki"` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 18: <define>
   - `guide.md` line 48: Jiki
   - `guide.md` line 74: Jiki
   - `guide.md` line 93: Jiki
   - `guide.md` line 148: Jiki
   - `guide.md` line 177: Jiki
   - `guide.md` line 214: Jiki
   - `guide.md` line 215: Jiki
   - `guide.md` line 216: Jiki
   - `guide.md` line 223: Jiki
   - `glossary.md` line 44: Jiki
   - `glossary.md` line 78: <define>
   - `glossary.md` line 80: <define>
   - `glossary.md` line 90: Jiki
