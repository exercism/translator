# TODO: adapt Italian for Exercism
...
- `glossary.md`: removed the whole section `### Exercise domain vocabulary` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 153: Jiki
   - `guide.md` line 154: Jiki
   - `glossary.md` line 24: <define>
   - `glossary.md` line 26: <define>
   - `glossary.md` line 50: Jiki
   - `glossary.md` line 51: Jiki
   - `glossary.md` line 59: <define>
   - `glossary.md` line 60: <define>
   - `glossary.md` line 75: Jiki
   - `glossary.md` line 76: Jiki
