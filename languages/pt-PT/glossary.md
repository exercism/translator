...
| English | Portuguese | Use (pt-PT/en) | Notes |
|---------|------------|-----------------|-------|
| course | curso | pt-PT | The whole course the reader is taking ("neste curso"). Keep distinct from _aula_ (lesson) and _currículo_ (curriculum). |
...
|------|----------------------------------|-------|
| framework | _estrutura de trabalho_ | Explain where the English itself explains the term, then use `framework` freely. |
| CLI (the concept) | interface de linha de comandos | Explain CLI as _interface de linha de comandos_ (plural "comandos") where the English itself explains the term. Diverges from pt-BR's singular "comando". |
