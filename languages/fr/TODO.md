# TODO: adapt French for Exercism
...
- `glossary.md`: removed the whole section `### Exercise world vocabulary` (Jiki's product, world or source-markup model).
