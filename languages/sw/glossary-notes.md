...
This glossary was forked from Jiki's Swahili glossary when Exercism's translator repo was
...
characters and physical metaphors) went with the fork; every decision about the Swahili
...
Swahili has been asked yet, and an agent's invented rendering would read as an agreed one.
