...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 12: Jiki
   - `guide.md` line 165: Jiki
   - `guide.md` line 224: Jiki
   - `guide.md` line 226: Jiki
   - `guide.md` line 227: Jiki
   - `guide.md` line 298: <define>
   - `guide.md` line 353: Jiki
   - `guide.md` line 354: Jiki
   - `glossary.md` line 27: <define>
   - `glossary.md` line 43: Jiki
   - `glossary.md` line 44: Jiki
   - `glossary.md` line 59: <define>
   - `glossary.md` line 94: <define>
   - `glossary.md` line 100: Jiki
   - `glossary.md` line 101: Jiki
   - `glossary.md` line 137: Jiki
   - `glossary.md` line 145: Jiki
   - `glossary.md` line 148: Jiki
   - `glossary.md` line 184: <define>
   - `glossary.md` line 185: <define>
   - `glossary.md` line 192: Jiki
   - `glossary.md` line 193: Jiki
