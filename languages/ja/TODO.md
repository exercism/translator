# TODO: adapt Japanese for Exercism
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 16: Jiki
   - `guide.md` line 30: Jiki
   - `guide.md` line 31: Jiki
   - `guide.md` line 50: Jiki
   - `guide.md` line 51: Jiki
   - `guide.md` line 71: <define>
   - `guide.md` line 99: Jiki
   - `guide.md` line 158: Jiki
   - `glossary.md` line 26: Jiki
   - `glossary.md` line 40: Jiki
   - `glossary.md` line 41: Jiki
   - `glossary.md` line 51: Jiki
   - `glossary.md` line 52: Jiki
   - `glossary.md` line 70: <define>
   - `glossary.md` line 78: Jiki
