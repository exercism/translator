# TODO: adapt Arabic for Exercism
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 27: Jiki
   - `guide.md` line 86: <define>
   - `guide.md` line 101: <define>
   - `guide.md` line 105: <define>
   - `guide.md` line 116: Jiki
   - `guide.md` line 129: Jiki
   - `guide.md` line 132: Jiki
   - `guide.md` line 140: Jiki
   - `glossary.md` line 40: Jiki
   - `glossary.md` line 50: Jiki
   - `glossary.md` line 51: Jiki
   - `glossary.md` line 63: <define>
   - `glossary.md` line 69: Jiki
   - `glossary.md` line 71: Jiki
   - `glossary.md` line 76: <define>
   - `glossary.md` line 77: <define>
   - `glossary.md` line 79: Jiki
