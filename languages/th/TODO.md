...
- `guide.md`: removed the whole section `## Term clarification (Thai realisation)` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 9: <define>
   - `guide.md` line 26: Jiki
   - `guide.md` line 28: Jiki
   - `guide.md` line 29: Jiki
   - `glossary.md` line 22: <define>
   - `glossary.md` line 48: <define>
   - `glossary.md` line 51: Jiki
   - `glossary.md` line 53: Jiki
   - `glossary.md` line 62: <define>
   - `glossary.md` line 63: <define>
   - `glossary.md` line 70: Jiki
   - `glossary.md` line 101: Jiki
   - `glossary.md` line 102: Jiki
   - `glossary.md` line 112: <define>
