# TODO: adapt Polish for Exercism
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 22: Jiki
   - `guide.md` line 67: Jiki
   - `guide.md` line 68: Jiki
   - `guide.md` line 82: Jiki
   - `guide.md` line 86: Jiki
   - `guide.md` line 105: Jiki
   - `glossary.md` line 31: Jiki
   - `glossary.md` line 46: Jiki
   - `glossary.md` line 65: Jiki
   - `glossary.md` line 66: Jiki
   - `glossary.md` line 114: Jiki
   - `glossary.md` line 120: Jiki
   - `glossary.md` line 126: <define>
   - `glossary.md` line 128: <define>
   - `glossary.md` line 130: <define>
   - `glossary.md` line 132: Jiki
   - `glossary.md` line 138: Jiki
