# TODO: adapt Catalan for Exercism
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 39: Jiki
   - `guide.md` line 40: Jiki
   - `guide.md` line 41: Jiki
   - `guide.md` line 58: Jiki
   - `guide.md` line 76: Jiki
   - `guide.md` line 77: Jiki
   - `glossary.md` line 22: Jiki
