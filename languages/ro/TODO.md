# TODO: adapt Romanian for Exercism
...
- `guide.md`: removed the whole section `## Term clarification (Romanian realisation)` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `glossary.md` line 86: Jiki
   - `glossary.md` line 103: <define>
