# TODO: adapt Croatian for Exercism
...
- `guide.md`: removed the whole section `## Term clarification (Croatian realisation)` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `glossary.md` line 58: Jiki
   - `glossary.md` line 59: Jiki
   - `glossary.md` line 63: <define>
   - `glossary.md` line 110: Jiki
   - `glossary.md` line 157: <define>
   - `glossary.md` line 177: Jiki
   - `glossary.md` line 188: <define>
