# TODO: adapt Indonesian for Exercism
...
- `glossary.md`: removed the whole section `## Exercise vocabulary` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 56: Jiki
   - `guide.md` line 58: Jiki
   - `glossary.md` line 13: <define>
   - `glossary.md` line 42: <define>
   - `glossary.md` line 44: <define>
   - `glossary.md` line 45: <define>
   - `glossary.md` line 55: <define>
   - `glossary.md` line 56: Jiki
   ...
   - `glossary.md` line 87: <define>
   - `glossary.md` line 88: <define>
   - `glossary.md` line 89: <define>
   - `glossary.md` line 90: <define>
   - `glossary.md` line 91: <define>
   - `glossary.md` line 93: <define>
   - `glossary.md` line 95: <define>
