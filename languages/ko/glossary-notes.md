...
This glossary was forked from Jiki's Korean glossary when Exercism's translator repo was
...
characters and physical metaphors) went with the fork; every decision about the Korean
...
Korean has been asked yet, and an agent's invented rendering would read as an agreed one.
