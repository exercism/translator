# TODO: adapt German for Exercism
...
- `guide.md`: removed the whole section `## The `<define>` gloss format` (Jiki's product, world or source-markup model).
...
2. **Remove what is left of Jiki**, by hand, because each line needs a judgement a script cannot
   ...
   - `guide.md` line 73: Jiki
   - `glossary.md` line 28: <define>
   - `glossary.md` line 37: Jiki
   - `glossary.md` line 51: Jiki, <define>
   - `glossary.md` line 52: Jiki
   - `glossary.md` line 72: <define>
   - `glossary.md` line 81: Jiki
   - `glossary.md` line 85: <define>
   - `glossary.md` line 87: <define>
   - `glossary.md` line 89: <define>
   - `glossary.md` line 98: Jiki
